...
function InvForm(props) {
  ...
  function handleAlert(isAllNotFilled) {
    if (isAllNotFilled) alert("Please fill all the Values of inventory form");
    else {
      props.onAdd(details);
    }
  }
  ...
  return (
    <div className="inv-form crd">
      <p
        ...
        style={{ textAlign: "center", paddingTop: "0px", paddingBottom: "0px" }}
      >
        Inventory Entry
      </p>
      <form style={{ width: "50%" }}>
        ...
        >
          ...
          <div class="form-group col-md-3">
            ...
            <input
              ...
              name="total_value"
              value={
                (details.total_value = details.unit_price * details.quantity)
              }
            />
          </div>
        </div>
